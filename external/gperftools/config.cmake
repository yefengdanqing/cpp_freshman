...
set(GPERFTOOLS_MAKE cd ${GPERFTOOLS_SOURCE_DIR}/src/gperftools_gperftools && make -j8)
set(GPERFTOOLS_INSTALL cd ${GPERFTOOLS_SOURCE_DIR}/src/gperftools_gperftools && make install)
