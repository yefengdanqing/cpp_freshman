...
set(SEASTAR_ROOT ${CMAKE_BINARY_DIR}/external/seastar)
...
list(APPEND BRPC_DEPENDS_PREFIX_PATH ${EXTERNAL_LEVELDB_ROOT})
#list(APPEND BRPC_DEPENDS_PREFIX_PATH ${ZLIB_ROOT})
list(APPEND BRPC_DEPENDS_PREFIX_PATH ${PROTOBUF_ROOT})
list(APPEND BRPC_DEPENDS_PREFIX_PATH "${EXTERNAL_GLOG_ROOT};")
